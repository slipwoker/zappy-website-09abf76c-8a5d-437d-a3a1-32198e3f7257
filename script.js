document.addEventListener('DOMContentLoaded', function () {
  ...
  function showFieldError(field, message) {
    ...
    field.addEventListener('input', function clearOnInput() {
      ...
      const msg = wrapper ? wrapper.querySelector('.field-error-message') : null;
      if (msg) msg.remove();
  ...
  function handleFormSuccess(form) {
    ...
    successEl.textContent = 'Your message has been sent successfully. We will be in touch soon.';
    ...
    setTimeout(function () {
      if (successEl.parentElement) successEl.remove();
    }, 6000);
  }
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '09abf76c-8a5d-437d-a3a1-32198e3f7257',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '09abf76c-8a5d-437d-a3a1-32198e3f7257';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '09abf76c-8a5d-437d-a3a1-32198e3f7257';
